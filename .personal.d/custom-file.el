...
(custom-set-faces
 ...
 '(org-document-title ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.5 :weight medium))))
 '(org-indent ((t (:inherit (org-hide fixed-pitch)))))
 '(org-level-1 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.5))))
 '(org-level-2 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.4))))
 '(org-level-3 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.3))))
 '(org-level-4 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.2))))
 '(org-level-5 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1.1))))
 '(org-level-6 ((t (:family "Iosevka Term" :family "Avenir" :weight regular :height 1))))
